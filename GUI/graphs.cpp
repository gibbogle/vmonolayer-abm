...
GRAPH_SET tsGraphSet[] = {
    ...
    "/hour",
    "# divided/hour",
    67, true, 0, 1, 0, TS_TYPE},

    {"G1_phase",
    "G1 phase %",
    "%",
    "% of cells in G1 phase",
    68, false, 0, 0.001, 0, TS_TYPE},

    {"G1_cp",
    "G1 checkpoint %",
    "%",
    "% of cells in G1 checkpoint",
    69, false, 0, 0.001, 0, TS_TYPE},

    {"S_phase",
    "S phase %",
    "%",
    "% of cells in S phase",
    70, false, 0, 0.001, 0, TS_TYPE},

    {"G2_phase",
    "G2 phase %",
    "%",
    "% of cells in G2 phase",
    71, false, 0, 0.001, 0, TS_TYPE},

    {"G2_cp",
    "G2 checkpoint %",
    "%",
    "% of cells in G2 checkpoint",
    72, false, 0, 0.001, 0, TS_TYPE},

    {"M_phase",
    "M phase %",
    "%",
    "% of cells in M phase",
    73, false, 0, 0.001, 0, TS_TYPE},

    {"S_phase_nonarrest",
    "S phase non-arrested %",
    "%",
    "% of non-arrested cells in S phase",
    74, false, 0, 0.001, 0, TS_TYPE},
