...
// Time-series plots
    ...
    {"nATPdead",                  0, 0,1,"","Total number of cells that have been killed by low ATP"},
    {"nGLNdead",                  1, 0,1,"","Total number of cells that have been killed by low GLN"},
    ...
    {"Orate",                     1, 0,1,"","Normalised oxygen consumption rate"},
